...
public final class StudentRecordsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.msj.generated.FingerLookupRequest,
      com.msj.generated.FingerLookupResponse> getLookupFingerIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "lookupFingerId",
      requestType = com.msj.generated.FingerLookupRequest.class,
      responseType = com.msj.generated.FingerLookupResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.msj.generated.FingerLookupRequest,
      com.msj.generated.FingerLookupResponse> getLookupFingerIdMethod() {
    io.grpc.MethodDescriptor<com.msj.generated.FingerLookupRequest, com.msj.generated.FingerLookupResponse> getLookupFingerIdMethod;
    if ((getLookupFingerIdMethod = StudentRecordsServiceGrpc.getLookupFingerIdMethod) == null) {
      synchronized (StudentRecordsServiceGrpc.class) {
        if ((getLookupFingerIdMethod = StudentRecordsServiceGrpc.getLookupFingerIdMethod) == null) {
          StudentRecordsServiceGrpc.getLookupFingerIdMethod = getLookupFingerIdMethod = 
              io.grpc.MethodDescriptor.<com.msj.generated.FingerLookupRequest, com.msj.generated.FingerLookupResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "StudentRecordsService", "lookupFingerId"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.msj.generated.FingerLookupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.msj.generated.FingerLookupResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new StudentRecordsServiceMethodDescriptorSupplier("lookupFingerId"))
                  .build();
          }
        }
     }
     return getLookupFingerIdMethod;
  }

  private static volatile io.grpc.MethodDescriptor<com.msj.generated.AttendanceRecord,
      com.msj.generated.AttendanceResponse> getProduceRecordMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "produceRecord",
      requestType = com.msj.generated.AttendanceRecord.class,
      responseType = com.msj.generated.AttendanceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.msj.generated.AttendanceRecord,
      com.msj.generated.AttendanceResponse> getProduceRecordMethod() {
    io.grpc.MethodDescriptor<com.msj.generated.AttendanceRecord, com.msj.generated.AttendanceResponse> getProduceRecordMethod;
    if ((getProduceRecordMethod = StudentRecordsServiceGrpc.getProduceRecordMethod) == null) {
      synchronized (StudentRecordsServiceGrpc.class) {
        if ((getProduceRecordMethod = StudentRecordsServiceGrpc.getProduceRecordMethod) == null) {
          StudentRecordsServiceGrpc.getProduceRecordMethod = getProduceRecordMethod = 
              io.grpc.MethodDescriptor.<com.msj.generated.AttendanceRecord, com.msj.generated.AttendanceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "StudentRecordsService", "produceRecord"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.msj.generated.AttendanceRecord.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.msj.generated.AttendanceResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new StudentRecordsServiceMethodDescriptorSupplier("produceRecord"))
                  .build();
          }
        }
     }
     return getProduceRecordMethod;
  }
  ...
  public static abstract class StudentRecordsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void lookupFingerId(com.msj.generated.FingerLookupRequest request,
        io.grpc.stub.StreamObserver<com.msj.generated.FingerLookupResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getLookupFingerIdMethod(), responseObserver);
    }

    /**
     */
    public void produceRecord(com.msj.generated.AttendanceRecord request,
        io.grpc.stub.StreamObserver<com.msj.generated.AttendanceResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getProduceRecordMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getLookupFingerIdMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.msj.generated.FingerLookupRequest,
                com.msj.generated.FingerLookupResponse>(
                  this, METHODID_LOOKUP_FINGER_ID)))
          .addMethod(
            getProduceRecordMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.msj.generated.AttendanceRecord,
                com.msj.generated.AttendanceResponse>(
                  this, METHODID_PRODUCE_RECORD)))
          .build();
    }
  }
  ...
  public static final class StudentRecordsServiceStub extends io.grpc.stub.AbstractStub<StudentRecordsServiceStub> {
    ...
    public void lookupFingerId(com.msj.generated.FingerLookupRequest request,
        io.grpc.stub.StreamObserver<com.msj.generated.FingerLookupResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getLookupFingerIdMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void produceRecord(com.msj.generated.AttendanceRecord request,
        io.grpc.stub.StreamObserver<com.msj.generated.AttendanceResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getProduceRecordMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class StudentRecordsServiceBlockingStub extends io.grpc.stub.AbstractStub<StudentRecordsServiceBlockingStub> {
    ...
    /**
     */
    public com.msj.generated.FingerLookupResponse lookupFingerId(com.msj.generated.FingerLookupRequest request) {
      return blockingUnaryCall(
          getChannel(), getLookupFingerIdMethod(), getCallOptions(), request);
    }

    /**
     */
    public com.msj.generated.AttendanceResponse produceRecord(com.msj.generated.AttendanceRecord request) {
      return blockingUnaryCall(
          getChannel(), getProduceRecordMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class StudentRecordsServiceFutureStub extends io.grpc.stub.AbstractStub<StudentRecordsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.msj.generated.FingerLookupResponse> lookupFingerId(
        com.msj.generated.FingerLookupRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getLookupFingerIdMethod(), getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.msj.generated.AttendanceResponse> produceRecord(
        com.msj.generated.AttendanceRecord request) {
      return futureUnaryCall(
          getChannel().newCall(getProduceRecordMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_PERIOD_RECORDS = 0;
  private static final int METHODID_REGISTER_ROOM = 1;
  private static final int METHODID_LOOKUP_FINGER_ID = 2;
  private static final int METHODID_PRODUCE_RECORD = 3;
      ...
      switch (methodId) {
        ...
        case METHODID_REGISTER_ROOM:
          serviceImpl.registerRoom((com.msj.generated.RegisterRoomRequest) request,
              (io.grpc.stub.StreamObserver<com.msj.generated.RegisterRoomResponse>) responseObserver);
          break;
        case METHODID_LOOKUP_FINGER_ID:
          serviceImpl.lookupFingerId((com.msj.generated.FingerLookupRequest) request,
              (io.grpc.stub.StreamObserver<com.msj.generated.FingerLookupResponse>) responseObserver);
          break;
        case METHODID_PRODUCE_RECORD:
          serviceImpl.produceRecord((com.msj.generated.AttendanceRecord) request,
              (io.grpc.stub.StreamObserver<com.msj.generated.AttendanceResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (StudentRecordsServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getLookupFingerIdMethod())
              .addMethod(getProduceRecordMethod())
              .build();
        }
      }
    }
